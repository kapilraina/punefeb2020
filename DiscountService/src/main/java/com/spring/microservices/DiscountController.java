...
import com.spring.microservices.audit.AuditService;
import com.spring.microservices.audit.stream.DiscountStreamService;
...
public class DiscountController {
	...
	public DiscountResponse calculateDiscount(@RequestBody DiscountRequest request) {
		...
		try {
			...
			// Should be taken to an async thread to not block the response, since this is a
			// realtime call from other MS.
